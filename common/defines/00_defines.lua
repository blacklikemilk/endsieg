...
NCountry = {
	...
	BOMBING_WAR_SUPPORT_PENALTY_SCALE = -0.00010, 			-- Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
	...
	MAX_HEROES_BEING_KILLED_WEEKLY_WAR_SUPPORT_PENALTY = -0.03,		-- Max penalty that will gained per week from war heroes manpower lost
	HEROES_BEING_KILLED_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.0001,	-- Weekly decay of war heroes manpower lost war support penalty
	MAX_HEROES_BEING_KILLED_WAR_SUPPORT_IMPACT = -0.2,				-- Max total penalty from war heroes manpower lost
	...
	GIE_ESCAPING_DIVISIONS_EQUIPMENT_RATIO = 0.1, -- Base equipment ratio on escaped troops.
...
NTechnology = {
	...
	DEFAULT_XP_RESEARCH_COST = 200,			-- default xp cost of a research to speed up the process
...
NMilitary = {
	...
	DIVISION_SIZE_FOR_XP = 1,                   -- how many battalions should a division have to count as a full divisions when calculating XP stuff
...
NAI = {
	...
	DESPERATE_AI_MIN_ORG_BEFORE_ATTACK = 0.25,					-- ai will wait for this much org to attack an enemy prov in desperate situations
