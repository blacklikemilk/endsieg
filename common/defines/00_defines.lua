...
NDiplomacy = {
	...
	ATTACHE_TO_SUBJECT_EFFECT = -0.05,				-- If overlord sent attaches to the subject it loses autonomy
...
NCountry = {
	...
	INDUSTRY_SCORE_MULTIPLIER = 0.7,				-- Based on number of factories.
	...
	MAX_BOMBING_WAR_SUPPORT_IMPACT = 0.2,			-- Max impact of bombing on the war support
	INTERCEPTION_WAR_SUPPORT_SCALE = 0.00002,		-- Scaling of interceptions to war support impact
	HEROES_BEING_KILLED_WAR_SUPPORT_IMPACT = 0.2,	-- Max impact of war heroes being killed
...
NProduction = {
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 300000,	-- How many deployment lines minimum can be training
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 7.5,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
...
NDeployment = {
	BASE_DEPLOYMENT_TRAINING = 1.5,		-- Base training done each day during deployment.
},
...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 90,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	BASE_LEADER_TRAIT_GAIN_XP = 1.0,				   -- Base xp gain for traits per hour.
	...
	PLAN_PROVINCE_HIGH_VP_IMPORTANCE_AREA = 25.0,   -- Used when calculating the value of defense area in the battle plan system
	...
	-- chances to gain a basic trait for new generals
	NEW_COMMANDER_RANDOM_BASIC_TRAIT_CHANCES = {   },

	-- chances to gain a status trait for new generals
	NEW_COMMANDER_RANDOM_STATUS_TRAIT_CHANCES = {   },

	-- chances to give a random stat skill for new generals
	...
	UNIT_LEADER_ASSIGN_TRAIT_COST = 10.0,					-- cost to assign a new trait to a unit leader
...
NAir = {
	...
	BOMBING_INFRA_PRIO_SCALE = 0.7,					-- Scale of the selected priority for infastructure
},
...
NAI = {
	...
	DIPLOMACY_ACCEPT_VOLUNTEERS_BASE = 80,		-- Base value of volunteer acceptance (help is welcome)

	DIPLOMACY_ACCEPT_ATTACHE_BASE = 80,			-- Base value of attache acceptance (help is welcome)
	DIPLOMACY_ACCEPT_ATTACHE_OPINION_TRASHHOLD = 15, -- Value of opinion that will remove accepting penalty for receiveing the attache
	DIPLOMACY_ACCEPT_ATTACHE_OPINION_PENALTY = -90, -- Value of acceptance penalty if the opinion too low
	...
	PLAN_VALUE_TO_EXECUTE = 0.30,				-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_MED = 0.55,		-- (LOW,MED,HIGH) corresponds to the plan execution agressiveness level.
	...
	ORG_UNIT_STRONG = 0.6,						-- Organization % for unit to be considered strong
	...
	DESPERATE_AI_MIN_ORG_BEFORE_ATTACK = 0.2,					-- ai will wait for this much org to attack an enemy prov in desperate situations
	...
	HOUR_BAD_COMBAT_REEVALUATE = 75,                   -- if we are in combat for this amount and it goes shitty then try skipping it
