...
NMilitary = {
	...
	CORPS_COMMANDER_CAP = 30,			-- how many a corps commander is limited to. 0 = inf
	FIELD_MARSHALL_CAP = 90,			-- how many a marshall is limited to. 0 = inf
	...
	PLAN_SPREAD_ATTACK_WEIGHT = 25.0,				-- The higher the value, the less it should crowd provinces with multiple attacks.
	...
	PLAN_EXECUTE_CAREFUL_LIMIT = 0,				-- When looking for an attach target, this score limit is required in the battle plan to consider province for attack
